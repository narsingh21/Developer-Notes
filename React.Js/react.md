...
3. [useEffect Hook](#section-3-useeffect-hook) - Side effects & cleanup
4. [Rules for Hooks](#section-4-rules-for-hooks) - Best practices
5. [Class Components](#section-5-class-components) - Legacy React
6. [useReducer Hook](#section-6-usereducer-hook) - State management
7. [React Router](#section-7-react-router) - Navigation
8. [Context API](#section-8-context) - State sharing
9. [Performance Optimization](#section-9-performance-optimization) - Speed up React apps
10. [Redux](#section-10-redux) - Global state management
11. [Next.js](#section-11-nextjs) - SSR & Server Components
12. [Data Fetching](#section-12-data-fetching-data-streaming-data-rendering) - Suspense & streaming

---

## Section 1: React Fundamentals

This page contains React questions. Some questions are not answered - you can take help from any AI or chatGPT tool for answers.
...
1. Hooks should render in the sequence as they had render in last render if you introduce a conditional hook or early return before all hook got executed that will cause a bug in React. So you can't render a hook conditionally.
...
How React Works - when a parent component is re-render then all the child component is re-render again even if the props is still same. It can be a big drawback in performance.
...
```bash
npm i redux react-redux redux-thunk redux-devtool-extension
```
